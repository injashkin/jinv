---
title: Введение в стилизацию на Gatsby
date: "2020.02.28"
---

<!-- Идея: создать глоссарий для ссылок. Многие из этих терминов путаются -->
...
В этой части вы изучите варианты оформления веб-сайтов Gatsby и более глубоко погрузитесь в использование компонентов React для создания сайтов.
...
#### Включите таблицу стилей в `gatsby-browser.js`
...
>  Файл `gatsby-browser.js` - один из немногих специальных файлов, которые ищет и использует (если они существуют) Gatsby. Здесь, имя файла **должно** именно таким. Если вы хотите изучить больше сейчас, проверьте [документы] (https://www.gatsbyjs.org/docs/browser-apis/).
...
Вы заметите, что импортировали файл модуля css с именем `container.module.css`. Давайте создадим этот файл сейчас.
